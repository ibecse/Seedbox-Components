...
declare -a qb_ver_list=("4.1.9" "4.1.9.1" "4.2.5" "4.3.8" "4.3.9" "4.4.5" "4.5.5" "4.6.3" "4.6.5" "4.6.5.1" "4.6.5.2" "5.0.4")
...
declare -a lib_ver_list=("1_1_14" "v1.2.14" "v1.2.19" "v1.2.20" "v2.0.10")
...
install_qBittorrent_(){
	...
	wget https://raw.githubusercontent.com/ibecse/Seedbox-Components/main/Torrent%20Clients/qBittorrent/$arch/$qb_ver%20-%20$lib_ver/qbittorrent-nox -O $HOME/qbittorrent-nox && chmod +x $HOME/qbittorrent-nox
